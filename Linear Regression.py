...
#Importing the dataset
            df = pd.read_csv("C:/Users/Akash/PycharmProjects/akash/CSV/Loss_Given_Default.csv")
            df
            df.shape
            df.dtypes
        ...
        df.rename(columns={'Losses in Thousands':'tar_var'})
        df.columns
...
## The One-Way Anova test
            ...
            dict
            stats.f_onewa(dyict['Married'], dict['Single'])
